...
export const generatePostTool = createTool({
  ...
  inputSchema: z.object({
    platform: z.enum(['twitter', 'linkedin', 'meta', 'instagram']).describe('Target platform. meta = Facebook (image optional). instagram = Instagram feed (image REQUIRED — cannot post without one).'),
